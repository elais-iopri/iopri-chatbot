...
def load_knowledge_graph():
    return Neo4jGraph(
        url = st.secrets['neo4j_product_knowledge']["NEO4J_URI"],
        username = st.secrets['neo4j_product_knowledge']["NEO4J_USERNAME"],
        password = st.secrets['neo4j_product_knowledge']["NEO4J_PASSWORD"],
    )
